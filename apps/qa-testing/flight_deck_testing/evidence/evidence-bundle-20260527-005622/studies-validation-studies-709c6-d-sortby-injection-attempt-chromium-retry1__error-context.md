...
- Name: studies-validation.spec.js >> Studies API validations and hardening >> @validation scenario 14: studies invalid sortBy (injection attempt)
- Location: tests\studies-validation.spec.js:57:3
