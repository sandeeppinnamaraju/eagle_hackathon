...
- Name: studies-validation.spec.js >> Studies API validations and hardening >> @validation scenario 12: studies invalid phase
- Location: tests\studies-validation.spec.js:47:3
