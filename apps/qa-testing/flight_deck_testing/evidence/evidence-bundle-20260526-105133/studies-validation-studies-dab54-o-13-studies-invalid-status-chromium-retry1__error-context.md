...
- Name: studies-validation.spec.js >> Studies API validations and hardening >> @validation scenario 13: studies invalid status
- Location: tests\studies-validation.spec.js:52:3
